...
<required_reading>
@C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude
                  → checks C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done
                  → writes to C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/hooks/
...
@C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
