      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button
              onClick={() => router.back()}
              className="p-2 hover:bg-zinc-50 dark:hover:bg-[#2a2a2a] rounded-lg transition-colors"
            >
              <ArrowLeftIcon className="w-5 h-5 text-zinc-700 dark:text-white" />
            </button>
            <div>
              <h1 className="text-2xl font-bold text-zinc-700 dark:text-white">Empleados en Planilla</h1>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-zinc-700 dark:text-white">{formatCRC(totalGrossSalary)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-zinc-700 dark:text-white">{formatCRC(totalDeductions)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-zinc-700 dark:text-white">{formatCRC(totalNetSalary)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-zinc-50 dark:bg-zinc-900 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-green-700 dark:bg-[#4a4a4a] bg-opacity-10 rounded-lg">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <UserGroupIcon className="w-16 h-16 text-[#D2B48C] dark:text-zinc-600 mx-auto mb-3" />
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-zinc-200 dark:border-zinc-700">
                    <th className="text-left py-3 px-4 text-sm font-semibold text-zinc-700 dark:text-white">Empleado</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-zinc-700 dark:text-white">Identificación</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-zinc-700 dark:text-white">Puesto</th>
                    <th className="text-right py-3 px-4 text-sm font-semibold text-zinc-700 dark:text-white">Salario Bruto</th>
                    <th className="text-right py-3 px-4 text-sm font-semibold text-zinc-700 dark:text-white">Deducciones</th>
                    <th className="text-right py-3 px-4 text-sm font-semibold text-zinc-700 dark:text-white">Salario Neto</th>
                  </tr>
                </thead>
                <tbody>
                  {employees.map((employee) => (
                    <tr 
                      key={employee.id}
                      className="border-b border-zinc-200 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-[#2a2a2a] transition-colors"
                    >
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-zinc-700 dark:text-white">{employee.employee_name}</p>
