...
export default function EditEmployeePage({ params }: EditEmployeePageProps) {
  ...
  // Resetear formulario cuando se carguen los datos del empleado
  useEffect(() => {
    if (employee) {
      reset({
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#E7DCC1] flex items-center justify-center p-6">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <button
              onClick={() => router.push('/pages/employee/list')}
              className="flex items-center gap-2 px-4 py-2 bg-white text-[#3B4D36] rounded-lg hover:bg-[#F5F1E8] transition-colors border border-[#D2B48C]"
            >
        ...
        {/* Formulario */}
        <div className="bg-[#F9F1DC] rounded-xl shadow-lg border border-[#E0D6B7] overflow-hidden">
          ...
          <div className="p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {/* Nombres */}
              <div>
                <h3 className="text-lg font-medium text-[#3B4D36] mb-3 border-b border-[#D2B48C] pb-2">
                  Datos Personales
                </h3>
              ...
              {/* Botones de acción */}
              <div className="border-t border-[#E0D6B7] pt-6">
