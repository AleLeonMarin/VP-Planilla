...
export default function UsersPermissionsPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <section className="bg-white rounded-2xl shadow-sm p-6 border border-neutral-100">
          ...
          <div className="flex flex-col gap-2 w-full md:w-auto">
            <div className="flex rounded-xl border border-neutral-200 overflow-hidden">
              ...
              <button
                ...
                className="px-4 py-2 bg-neutral-900 text-white text-sm flex items-center gap-2"
              >
      ...
      <section className="grid gap-4 md:grid-cols-2">
        {roleOptions.map((role) => (
          ...
          >
            ...
            <p className="text-sm text-neutral-500 mb-3">{role.description}</p>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-neutral-100">
            ...
            <tbody className="divide-y divide-neutral-100">
              {loading ? (
                <tr>
                  <td className="px-6 py-6 text-center text-sm text-neutral-500" colSpan={4}>
                    Cargando usuarios...
                  </td>
                </tr>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {user.permissions.length === 0 ? (
                          ...
                          user.permissions.map((permission) => (
                            <span
                              key={permission}
                              className="inline-flex items-center px-2.5 py-1 rounded-full bg-neutral-100 text-xs text-neutral-700"
                            >
                              {permission}
                            </span>
                          ))
