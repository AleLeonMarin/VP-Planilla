  ...
  return (
    <div className="bg-[#FCF1D5] dark:bg-zinc-800 p-4 rounded-lg min-w-[220px]">
      ...
      <ul className="text-xs text-zinc-600 dark:text-zinc-400">
        ...
        <li className="flex justify-between"><span><Image src="/images/layout/noMarks.png" alt="Sin marcas" width={26} height={25} loading="lazy" /></span><span className="">Sin marcas</span> <span>{sinMarcas}</span></li>
      </ul>
    </div>
  );
};
