...
const DismissEmployeeModal: React.FC<DismissEmployeeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Panel */}
      <div className="relative z-10 w-full max-w-md bg-[#F9F1DC] rounded-xl shadow-2xl border border-[#D2B48C] overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          {/* Employee name */}
          <div>
            <label className="block text-xs font-bold text-[#5D4E37] uppercase tracking-widest mb-1">
              Empleado
            </label>
            <p className="text-base font-semibold text-[#3B4D36] bg-[#EDE4CC] rounded-lg px-4 py-2.5 border border-[#D2B48C]">
              {employeeName}
            </p>
          </div>
          ...
          <div>
            <label
              ...
              className="block text-xs font-bold text-[#5D4E37] uppercase tracking-widest mb-1"
            >
            ...
            <input
              ...
              disabled={busy}
              className="w-full px-3 py-2.5 border border-[#D2B48C] rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent bg-white text-[#3B4D36] text-sm"
            />
          </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[#D2B48C] bg-[#F2E8CF]">
          <button
            type="button"
            onClick={onClose}
            disabled={busy}
            className="px-4 py-2 text-sm border border-[#D2B48C] text-[#5D4E37] rounded-lg hover:bg-[#E7DCC1] transition-colors disabled:opacity-50"
          >
            Cancelar
          </button>
          <button
