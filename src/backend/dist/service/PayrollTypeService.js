...
exports.PayrollTypeService = void 0;
...
class PayrollTypeService {
     ...
     */
    static async createPayrollType(data) {
        try {
     ...
     */
    static async updatePayrollType(id, data) {
     ...
     */
    static async getPayrollTypeById(id) {
     ...
     * @throws Error if database query fails
     */
    static async getAllPayrollTypes() {
...
exports.PayrollTypeService = PayrollTypeService;
