...
exports.LaborEventsService = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class LaborEventsService {
    /**
     ...
     */
    static async createLaborEvent(data) {
     ...
     */
    static async updateLaborEvent(id, data) {
     ...
     */
    static async deleteLaborEvent(id) {
    ...
    static async getAllLaborEvents() {
        ...
        const laborEvents = prismaEvents.map((event) => ({
     ...
     */
    static async assignLaborEventsToEmployee(data) {
     ...
     */
    static async deleteEmployeeLaborEvent(id) {
        try {
...
exports.LaborEventsService = LaborEventsService;
