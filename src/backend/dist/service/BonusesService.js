...
class BonusesService {
     ...
     */
    static async updateBonus(id, data) {
        ...
        const updatedBonus = await prisma.vpg_bonuses.update({
            where: { bonuses_id: id },
            data: {
                bonuses_employee_id: data.employee_id ?? existingBonus.bonuses_employee_id,
                ...
                bonuses_description: data.description ?? existingBonus.bonuses_description,
