...
const VacationController_1 = require("../controller/VacationController");
 ...
 */
router.post("/vacations", (0, asyncHandler_1.asyncHandler)(VacationController_1.VacationController.createVacation));
/**
 * @route   GET /vacations
 ...
 *         description: Internal server error
 */
router.get("/vacations", (0, asyncHandler_1.asyncHandler)(VacationController_1.VacationController.getAllVacations));
/**
 ...
 *         description: Internal server error
 */
router.get("/vacations/:id", (0, asyncHandler_1.asyncHandler)(VacationController_1.VacationController.getVacationById));
/**
 ...
 *         description: Internal server error
 */
router.put("/vacations/:id", (0, asyncHandler_1.asyncHandler)(VacationController_1.VacationController.updateVacation));
/**
 ...
 *         description: Internal server error
 */
router.delete("/vacations/:id", (0, asyncHandler_1.asyncHandler)(VacationController_1.VacationController.deleteVacation));
