...
const LaborEventsController_1 = require("../controller/LaborEventsController");
 ...
 */
router.post("/labor-events/create", (0, asyncHandler_1.asyncHandler)(LaborEventsController_1.LaborEventsController.createLaborEvent));
/**
 ...
 *         description: Internal server error
 */
router.get("/labor-events", (0, asyncHandler_1.asyncHandler)(LaborEventsController_1.LaborEventsController.getAllLaborEvents));
/**
 ...
 *         description: Internal server error
 */
router.put("/labor-events/:id", (0, asyncHandler_1.asyncHandler)(LaborEventsController_1.LaborEventsController.updateLaborEvent));
/**
 ...
 *         description: Internal server error
 */
router.delete("/labor-events/:id", (0, asyncHandler_1.asyncHandler)(LaborEventsController_1.LaborEventsController.deleteLaborEvent));
/**
 ...
 *         description: Internal server error
 */
router.post("/labor-events/assign", (0, asyncHandler_1.asyncHandler)(LaborEventsController_1.LaborEventsController.assignLaborEventsToEmployee));
