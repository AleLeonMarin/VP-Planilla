...
const NomineeController_1 = require("../controller/NomineeController");
 ...
 */
router.get("/nominee/clocklogs", (0, asyncHandler_1.asyncHandler)(NomineeController_1.NomineeController.getClockLogs));
/**
 ...
 *         description: Internal server error
 */
router.get("/nominee/employee-deductions/:employeeId", (0, asyncHandler_1.asyncHandler)(NomineeController_1.NomineeController.getEmployeeDeductions));
/**
 ...
 *         description: Internal server error
 */
router.post("/nominee/calculate", (0, asyncHandler_1.asyncHandler)(NomineeController_1.NomineeController.calculateNominee));
/**
 ...
 *         description: Internal server error
 */
router.post("/nominee/calculate-payroll", (0, asyncHandler_1.asyncHandler)(NomineeController_1.NomineeController.calculatePayrollForPeriod));
