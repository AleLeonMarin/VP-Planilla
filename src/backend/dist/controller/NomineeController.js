...
exports.NomineeController = void 0;
const NomineeService_1 = require("../service/NomineeService");
class NomineeController {
     ...
     */
    static async getClockLogs(req, res) {
        try {
     ...
     */
    static async calculateNominee(req, res) {
        try {
            const nomineeService = new NomineeService_1.NomineeService();
...
exports.NomineeController = NomineeController;
