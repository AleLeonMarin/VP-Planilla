...
\subsubsection*{Descripción}
Este caso de uso permite al administrador calcular la nómina mensual de todos los empleados, tomando en cuenta los eventos laborales registrados, salario base, deducciones obligatorias, horas trabajadas y, en el mes de diciembre, el cálculo del aguinaldo conforme a la legislación laboral costarricense.
...
\begin{itemize}
	...
	\item En diciembre, deben estar disponibles los registros de salario bruto de los últimos 12 meses para cada empleado.
\end{itemize}
...
\begin{itemize}
	...
	\item Si el cálculo corresponde a diciembre, se incluye el aguinaldo como una línea separada en el comprobante de pago.
\end{itemize}
...
\begin{table}[h]
	...
	\begin{tabular}{|p{7cm}|p{7cm}|}
		...
		Si el mes es diciembre                               & El sistema calcula el aguinaldo como promedio anual de salarios brutos y lo agrega al resumen final \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|p{4cm}|p{6cm}|p{6cm}|}
		...
		E003                      & Datos de salario anual incompletos (diciembre) & Mostrar advertencia: "No es posible calcular el aguinaldo por falta de información" \\ \hline
	\end{tabular}
\end{table}
...
\begin{itemize}
	...
	\item Si el mes es diciembre, debe haberse calculado el aguinaldo.
\end{itemize}
...
\begin{itemize}
	...
	\item Si el mes es diciembre, el reporte incluye una sección específica para el aguinaldo.
\end{itemize}
...
\begin{table}[h]
	...
	\begin{tabular}{|p{7cm}|p{7cm}|}
		...
		Si el mes es diciembre                             & El sistema verifica la existencia del cálculo de aguinaldo y lo incluye en el reporte \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|p{7cm}|p{7cm}|}
		...
		En diciembre, no se ha calculado el aguinaldo           & El sistema muestra advertencia: "No se ha calculado el aguinaldo para este periodo" \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|p{3cm}|p{5cm}|p{5cm}|}
		...
		E003                      & Aguinaldo no disponible en diciembre & Mostrar mensaje: 'Falta el cálculo del aguinaldo para este periodo' \\ \hline
	\end{tabular}
\end{table}
