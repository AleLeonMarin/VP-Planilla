...
Plans:
- [ ] 25-01-PLAN.md — Refactor de servicios internos (auditLogs, branch, payrollEmployees) a http.ts
- [ ] 25-02-PLAN.md — Capa de API externa para clima y verificación final de cumplimiento
...
| 25. HTTP Client Layer Enforcement | v1.4 | 0/2 | In Progress | — |
