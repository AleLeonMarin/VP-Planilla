...
## Deferred Ideas
- **Gestión Avanzada y Drag & Drop**: La interfaz administrativa pesada para asignar y ajustar las propias "Ventanas de Tiempo" de cada empleado en su visualización usando Drag & Drop no se incluirá aquí para no engrosar la entrega técnica; en su lugar, se delega al Roadmap como Fase 52.
